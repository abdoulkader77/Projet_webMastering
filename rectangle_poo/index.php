   ...
   2)Traitements=>U.C
      ...
      //POO en PHP=>Rectangle
         ...
         //Nommination
           ...
           Erreur à corriger:
           1-affichage des 2 messages d'erreurs lorsque longeur=Vide et lorsqu'il y'a erreur au niveau de la Largeur 
           2-si largueur vide et et il y'a erreur au niveau de la longueur slmt le msg de la largeur s'affiche
           3-si longueur a l'erreur de siasi de nombre et il y'a erreur de largeur seul l'erreur de la longeur s'affiche 
   ...
   ///session_destroy();
    ...
    if( isset($_POST['btn_submit'])){
        ...
        $largeur=$_POST['largeur'];
          ...
          $validator->is_positif($largeur,'largeur');
